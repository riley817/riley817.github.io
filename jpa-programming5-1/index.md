...
```
{{<admonition type="success" title="정리">}}
...
### 순수한 객체 연관관계
객체는 참조를 사용해서 연관관계를 탐색할 수 있고 이것을 **객체 그래프 탐색**이라고 한다.
...
### 테이블 연관관계
데이터베이스는 외래 키를 사용하여 연관관계를 탐색할 수 있으며 이것을 **조인**이라고 한다.
...
{{<image src="/posts/images/jpa/5/20190721213200.png" width="100%">}}
